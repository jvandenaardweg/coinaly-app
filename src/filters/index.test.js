...
describe('filters/index.js', () => {
  it('should correctly capitalize text', () => {
    const capitalized = Vue.filter('capitalize')('test')
    expect(capitalized).toBe('TEST')
  })

  it('should correctly return a currency', () => {
  ...
  it('should correctly return a percentage number with suffix', () => {
