        ...
        <div class="text-center">
          ...
          <div class="card">
            ...
            <div class="card-footer">
              <button type="button" class="btn btn-primary btn-block" @click="steps.firstStep.validated = true" :class="{'disabled': quoteCurrency === null}" :disabed="quoteCurrency === null">Next step</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="text-center">
          ...
          <div class="card">
            ...
            <div class="card-footer">
              ...
              <button type="button" class="btn btn-primary float-right" @click="steps.secondStep.validated = true" :class="{'disabled': baseCurrency === null}" :disabed="baseCurrency === null">Next step</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-5">
        <div class="text-center">
          ...
          <div class="card">
            ...
            <div class="card-footer">
              <button type="button" class="btn btn-outline-secondary float-left" @click="steps.firstStep.validated = false">Previous step</button>
              <button type="button" class="btn btn-primary float-right" @click="steps.secondStep.validated = true" :class="{'disabled': baseCurrency === null}" :disabed="baseCurrency === null">Sell</button>
            </div>
          </div>
        </div>
      </div>
